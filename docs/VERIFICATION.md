...
| CDN behavior |10/10 second-pass HIT; observed median 54ms versus first-pass3342ms MISS | [after](evidence/r3/logo-after.json) |
| Error boundary |Unauthorized logo404/no-store, invalid URL400, public writes405, operator GET404 | [checks](evidence/r3/public-api-checks.json) |
