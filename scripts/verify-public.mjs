...
assert.deepEqual([overview.policy.rewardsBps, overview.policy.buybackBps, overview.policy.operationsBps], [8000, 1000, 1000]);
assert.equal(overview.selection.requiredCount, 10);
...
assert.equal(overview.accounting.withdrawableRemainder, null);
assert.equal(overview.accounting.finalizedDevPayments, null);
